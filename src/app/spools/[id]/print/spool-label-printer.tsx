...
type FilamentFields = Omit<Filament, "id" | "created_at">;
...
interface SpoolLabelPrinterProps {
  filament: Omit<Filament, "id" | "created_at">;
  qrUrl: string;
}
...
export function SpoolLabelPrinter({ filament: gf, qrUrl }: SpoolLabelPrinterProps) {
